...
-- This creates sample tables with proper RLS policies based on Clerk user IDs in JWT `sub`
...
CREATE TABLE IF NOT EXISTS public.collaborations (
  ...
  collaborators TEXT[] DEFAULT '{}'::text[], -- Array of collaborator Clerk user IDs
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
